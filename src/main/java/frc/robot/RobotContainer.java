...
public class RobotContainer {
  ...
  private static RobotContainer m_robotContainer = new RobotContainer();
   ...
   // public final ArmMoveSub m_armMoveSub = new ArmMoveSub();
    public final RampSub m_rampSub = new RampSub();
    public final Command m_auto_NO_Dock = new Auto_NO_Dock();
    public final Command m_auto_Dock = new Auto_Dock();
  ...
  */
  private RobotContainer() {
    ...
    //m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand());
     m_chooser.setDefaultOption("NO DOCK",m_auto_NO_Dock);
     m_chooser.addOption("DOCK",m_auto_Dock);
