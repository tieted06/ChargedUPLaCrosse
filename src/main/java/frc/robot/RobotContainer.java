  ...
  */
  private RobotContainer() {
    ...
    //m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand());
     m_chooser.setDefaultOption("NO DOCK",new Auto_NoDock(m_driveSub, m_clawSub, m_armSub));
     m_chooser.addOption("DOCK",new Auto_Dock(m_driveSub, m_clawSub, m_armSub));
     m_chooser.addOption("DO NOTHING",new Do_Nothing_Auto(m_driveSub, m_clawSub, m_armSub));
